...
def main():
    directory_path = '/home/kowkodivka/Документы/heart_valve_model/photo/raw/'
    output_directory = '/home/kowkodivka/Документы/heart_valve_model/photo/processed/'
    ...
    images_to_vox(output_directory, './valve.vox', proc_regex_pattern)
